...
(sleep 630m; killall -9 cheri-bgas-fuse-devfs) & timeout --foreground 10h ./cheri-bgas-sim.py  -v --simulation-run-directory ~/Dissertation-riga/simulations_v2/$1/$2/$3 --simulation-build-dir ~/Dissertation-riga/simulations_v2/$1/$2/build/simdir/sim_CHERI_BGAS
pigz ~/Dissertation-riga/simulations_v2/$1/$2/$3/sim_0.0/sim_stdout
cd analyse
